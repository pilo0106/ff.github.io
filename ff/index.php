...
<html lang="ch, en">
	...
	<body>
    	...
    	<?php else:?>
		<div class="main">
			<form action="check_login.php" method="post">  <!--連結php-->
				<div class="signupFrm">
                    <div class="form">
                        <div style="position: relative;">
                            <h1 class="title">登入</br></br></h1>
                        </div>
						<?php 
                        ...
                        <div class="inputContainer">
							...
							<input type="text" name="un" class="input" placeholder="" required>
                        </div>
						...
						<div class="logintext">
							<a href="register.php"></br>還沒註冊?&nbsp&nbsp&nbsp&nbsp</a>
							<a href="wait.php">忘記密碼?</br></a>
						</div>
