...
<html lang="ch, en">
	...
	<body>
		...
		<div class="main">			
			<nav>
				<label for="touch"><span>個人資料設定</span></label>               
				<input type="checkbox" id="touch"> 
			
				<ul class="slide">
					<li><button class="menubutton" onclick="openCity(event, 'password')">更改密碼</button></li>
					<li><button class="menubutton" onclick="openCity(event, 'mail')">更改E-mail</button></li>
				</ul>
			</nav>
				...
				<div class="user">
					<div class="page">
						<div id="password" class="tabcontent">
							<p >更改密碼</p>
							<form  name="Form" action="updatepassword.php" method="post" onsubmit="return validateForm()">
								<div class="inputContainer">
									<label for="" class="label" id="pic">
									...
									<input name="pw" type="text" class="input" maxlength="15" placeholder="請輸入舊密碼" required>
								</div>
								<div class="inputContainer2">
									...
									<input name="newpw" type="text" class="input2" maxlength="15" placeholder="請輸入新密碼" required>
									<div class="Btn" style="position: relative;">
										<input type="submit" class="submitBtn" value="更改">
									</div>
								</div>
							</form>
						</div>
						...
						<div id="mail" class="tabcontent">
							...
							<form action="updatemail.php" method="post">
								<div class="inputContainer">
									...
									<input name="pw" type="text" class="input" maxlength="15" placeholder="請輸入密碼" required>
								</div>
								<div class="inputContainer2">
									<label for="" class="label">
									...
									<input name="mail" type="text" class="input2" placeholder="請輸入新郵件" required>
									<div class="Btn" style="position: relative;">
										<input type="submit" class="submitBtn" value="更改">
									</div>
								</div>
