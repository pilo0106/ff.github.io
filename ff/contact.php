	...
	<body>
		...
		<div class="main">
			<div class="contactposition">
				<div class="contact">
					<div class="tab">
						<button class="tablinks" onclick="openCity(event, 'all')">聯絡人</button>
						<button class="tablinks" onclick="openCity(event, 'new')">新增聯絡人</button>
					</div>
					<?php
						...
						<div id="all" class="tabcontent">
							<table>
									...
									<tr>
										...
										<td>
											<a href="##"><svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
										...
										<td>
											<a href="##"><svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16" >
					...
					<div class="page">
						<div id="new" class="tabcontent">
							<form action="addcontact.php" method="post">
								...
								<input type="text" name="findid" class="input" placeholder="請輸入聯絡人ID" required>
