       ...
       if($username == $password){
        ...
        exit;
            ...
            if(mysqli_query($conn, $sql)){
                function_alert("Registration succeeded!");
                header("refresh:32;url=en_index.php");
                exit;
            }
            else{
            ...
            $_SESSION['msg'] = 'Registration failed, the account is already used!';
            header('Location: en_register.php');
